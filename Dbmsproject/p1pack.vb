...
Public Class p1pack
    ...
    Private Sub load_table()
        ...
        Try
            MysqlConn.Open()
            Dim Query As String
            Query = "select package_id as 'Package ID',owner_name as 'Owner Name',owner_phone as 'Phone no',package_weight as 'Weight',package_ship_id as 'Ship ID' from harbour.package,harbour.ship where port_identity=22 and package_ship_id=ship_id"
            COMMAND = New MySqlCommand(Query, MysqlConn)
    ...
    Private Sub p1pack_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Timer1.Enabled = True
        load_table()
    End Sub
    ...
    Private Sub p1pack_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
