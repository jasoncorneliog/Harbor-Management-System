...
Public Class p1ship
    ...
    Private Sub p1ship_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Timer1.Enabled = True
        load_table()
    ...
    Private Sub p1ship_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        If (TextBox3.Text.Trim.Length > 0) Then
            Try
                MysqlConn.Open()
                Dim Query As String
                Query = "update harbour.ship set occupied_capacity='" & TextBox1.Text & "',free_capacity='" & TextBox2.Text & "',ship_status='" & shippy & "' where ship_id='" & TextBox3.Text & "' and port_identity=22"
                COMMAND = New MySqlCommand(Query, MysqlConn)
